...
Respond with ONLY valid JSON, no markdown fences:
{
  ...
  "voiceover": "one complete energetic sentence of 10-16 words total; it must fit comfortably in 8 seconds and end with 'Follow for daily AI tips'",
  ...
  "visualScenes": [
    ...
    "5-8 seconds: a waist-up human reaction or moving environmental result; hands remain out of frame and no one holds an object"
  ],
