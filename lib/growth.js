...
export const GROWTH_CTA_LINES = [
  ...
  "Comment HOW and I'll send you the AI playbook. Follow so you don't miss it.",
...
- End with the CTA "Comment HOW and I'll send you the AI playbook"
...
4. 14-16s COMMENT CTA: spoken exactly, "Comment HOW and I'll send you the AI playbook."
...
Respond with ONLY valid JSON, no markdown fences:
{
  ...
  "voiceoverSegments": [
    ...
    "clip 2: one complete payoff sentence, 5-10 words, then exactly: Comment HOW and I'll send you the AI playbook"
  ],
