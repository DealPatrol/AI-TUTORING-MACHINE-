...
Respond with ONLY valid JSON, no markdown fences:
{
  ...
  "visualScenes": [
    "0-2 seconds: physical live-action B-roll that symbolizes the problem without showing any screen or interface",
    "2-5 seconds: a different hands-on physical action using props, paper, camera gear, or real objects; every device screen faces away, is off, or is fully blurred",
    "5-8 seconds: a satisfying real-world result and human reaction with visible movement; no screens or text"
  ],
  "videoPrompt": "a concise cinematic direction for an actual live-action vertical video with three distinct moving physical B-roll shots, real people/hands/props/objects, natural lighting, camera movement, and visual storytelling; use physical metaphors for digital concepts; never show readable screens, phones, monitors, apps, websites, code, text, UI, static graphics, posters, slideshows, mascots, flat illustrations, or text-only animation",
