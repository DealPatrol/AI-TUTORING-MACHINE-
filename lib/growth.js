...
${FOLLOWER_RULES}
- Slide 1 leads with a specific result and says SWIPE
- Slides 2-4 reveal one copy-paste prompt in readable chunks, then show a
  realistic filled-in example or before/after result
- Final slide asks viewers to save the prompt and may offer more copy-ready workflows
...
Respond with ONLY valid JSON, no markdown fences:
{
  ...
  "slides": [
    ...
    { "headline": "slide 2", "body": "what input to paste" },
    { "headline": "slide 3", "body": "exact instruction, written so it can be copied" },
    { "headline": "slide 4", "body": "filled-in example and realistic output" },
    { "headline": "slide 5", "body": "one output-quality check or useful variation" },
    { "headline": "Save this prompt", "body": "Comment HOW for the expanded template" }
  ],
...
${FOLLOWER_RULES}
- Cover promises a specific useful collection and says SWIPE
- Each middle slide preserves the exact useful instruction from one tip
