...
Respond with ONLY valid JSON, no markdown fences:
{
  ...
  "visualScenes": [
    "0-2 seconds: a specific live-action scene that visually demonstrates the problem",
    "2-5 seconds: a different close-up action showing the AI tip being used",
    "5-8 seconds: a satisfying real-world result with visible movement"
  ],
  "videoPrompt": "a concise cinematic direction for an actual live-action vertical video with three distinct moving shots, real people/hands/objects as appropriate to the topic, natural lighting, camera movement, and visual storytelling; never describe a static graphic, poster, slideshow, mascot, flat illustration, or text-only animation",
